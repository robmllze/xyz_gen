...
void printUsage(ArgParser parser) {
  printLightCyan(
    [
      "XYZ Gen Screen Configurations",
      "Usage: dart generate_screen_configurations.dart -r <root_directory_path> -t <template_file_path>",
      "Example: dart generate_screen_configurations.dart -r ../my_xyz_project/lib/screens/ -t ../templates/screen_configuration_template.md",
      parser.usage
    ].join("\n"),
  );
}
