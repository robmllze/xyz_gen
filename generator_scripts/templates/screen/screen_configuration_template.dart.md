...
const PATH_ACCESSIBLE_ONLY_IF_SIGNED_IN_AND_VERIFIED____SCREEN_CONST_KEY___ //
  = ___LA0___ ? [_PATH]: [];
const PATH_ACCESSIBLE_ONLY_IF_SIGNED_IN____SCREEN_CONST_KEY___ //
  = ___LA1___ ? [_PATH]: [];
const PATH_ACCESSIBLE_ONLY_IF_SIGNED_OUT____SCREEN_CONST_KEY___ //
  = ___LA2___ ? [_PATH]: [];
const PATH_ACCESSIBLE____SCREEN_CONST_KEY___ //
  = ___LA3___ ? [_PATH]: [];
